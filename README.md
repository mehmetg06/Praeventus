...
- **Private by design.**
  ...
  - All requests go through a Deno Deploy backend — your device IP never reaches
...
swift run        # geocodes a city, fetches a forecast via the backend, prints the mapped model
```
