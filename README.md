...
The Cloudflare Worker fans out to two global NWP models in parallel — ECMWF
IFS 0.25° (MET Norway) and ICON (DWD, Germany) — and returns both
forecasts in a single JSON envelope. The app blends them on-device:
